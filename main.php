...
<html dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="container container-fluid latest_ads">
            <div class="sidebar">
                <div class="row">
                    <div class="span4 columns">
                        <h3><?php _e('Paginas', 'twitter') ; ?></h3>
                        <ul class="unstyled">
                            <?php while( osc_has_static_pages() ) { ?>
                            <li><a href="<?php echo osc_static_page_url() ; ?>"><?php echo osc_static_page_title() ; ?></a></li>
                            <?php } ?>
                            <li><a href="<?php echo osc_contact_url(); ?>"><?php _e('Contacto', 'twitter') ; ?></a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="content">
                <h1><?php _e('Últimos artículos publicados', 'twitter') ; ?></h1>
                <?php if( osc_count_latest_items() == 0) { ?>
                <p>
                    <?php _e('No hay artículos recientes', 'twitter') ; ?>
                </p>
                <?php } else { ?>
                    ...
                    <div class="row show-all-ads">
                        <div class="span12 columns">
                            <a class="btn primary" href="<?php echo osc_search_show_all_url();?>"><strong><?php _e("Ver todas las ofertas", 'twitter') ; ?> &raquo;</strong></a>
                        </div>
                    </div>
                    <?php } ?>
                <?php } ?>
