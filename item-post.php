            ...
            <div class="row">
                <div class="span16 columns">
                    <form class="well" name="item" action="<?php echo osc_base_url(true) ; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            <h1><?php _e('Publicar un artículo', 'twitter') ; ?></h1>
                            <!-- category input -->
                            <div class="clearfix">
                            ...
                            <div class="clearfix">
                                <label><?php _e('Nombre', 'twitter') ; ?></label>
                                <div class="input">
                                    <?php echo item_contact_name_input() ; ?>
                                </div>
                            </div>
                            <div class="clearfix">
                                <label><?php _e('Correo electronico', 'twitter') ; ?></label>
                                <div class="input">
                                    ...
                                    <ul class="inputs-list">
                                        <li>
                                            <label for="showEmail">
                                                ...
                                                <span><?php _e('Mostrar e-mail en la página del artículo', 'twitter'); ?></span>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <?php } ?>
                            <div class="actions">
                                <button class="btn" type="submit"><?php _e('Publica tu anuncio', 'twitter') ; ?></button>
                            </div>
                        </fieldset>
                    </form>
                </div>
